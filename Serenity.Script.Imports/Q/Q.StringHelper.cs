...
namespace Serenity
{
    public static partial class Q
    {
        ...
        [InlineCode("Q.isEmptyOrNull({str})")]
        ...
        [InlineCode("Q.isTrimmedEmpty({str})")]
