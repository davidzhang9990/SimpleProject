...
namespace Serenity
{
    ...
    {
        [InlineCode("Q.layoutFillHeightValue({element})")]
        public static int LayoutFillHeightValue(jQueryObject element)
        {
            return 0;
        }

        [InlineCode("Q.layoutFillHeight({element})")]
        public static void LayoutFillHeight(jQueryObject element)
        {
        }

        [InlineCode("Q.initFullHeightGridPage({gridDiv})")]
        ...
        [InlineCode("Q.autoFullHeight({element})")]
        public static void AutoFullHeight(this jQueryObject element)
        {
        }

        [InlineCode("Q.setMobileDeviceMode()")]
