...
(function (SimpleSence) {
    ...
    })(Administration = SimpleSence.Administration || (SimpleSence.Administration = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
    var Administration;
    (function (Administration) {
...
(function (SimpleSence) {
    ...
    })(BasicSamples = SimpleSence.BasicSamples || (SimpleSence.BasicSamples = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
    var BasicSamples;
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return SimpleSence.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = SimpleSence.BasicSamples || (SimpleSence.BasicSamples = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return SimpleSence.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return SimpleSence.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = SimpleSence.BasicSamples || (SimpleSence.BasicSamples = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return SimpleSence.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return SimpleSence.StaticTextBlock; }], ['FromLocalText', function () { return SimpleSence.StaticTextBlock; }], ['DisplayFieldValue', function () { return SimpleSence.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = SimpleSence.BasicSamples || (SimpleSence.BasicSamples = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
...
(function (SimpleSence) {
    ...
    })(Common = SimpleSence.Common || (SimpleSence.Common = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
    var Common;
...
(function (SimpleSence) {
    ...
    })(Meeting = SimpleSence.Meeting || (SimpleSence.Meeting = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
    var Meeting;
...
(function (SimpleSence) {
    ...
    })(Membership = SimpleSence.Membership || (SimpleSence.Membership = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
    var Membership;
...
(function (SimpleSence) {
    ...
    })(Northwind = SimpleSence.Northwind || (SimpleSence.Northwind = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
    var Northwind;
...
(function (SimpleSence) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'SimpleSence.Northwind.Entities.Gender');
    })(Northwind = SimpleSence.Northwind || (SimpleSence.Northwind = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
...
(function (SimpleSence) {
    ...
    })(Organization = SimpleSence.Organization || (SimpleSence.Organization = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
    var Organization;
...
(function (SimpleSence) {
    ...
    })(Authorization = SimpleSence.Authorization || (SimpleSence.Authorization = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
    var Administration;
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        }(SimpleSence.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(SimpleSence.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(SimpleSence.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        }(SimpleSence.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        SimpleSence.Common.ReportHelper.execute({
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: SimpleSence.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: SimpleSence.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new SimpleSence.Northwind.OrderDialog();
                        ...
                        var chai = SimpleSence.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = SimpleSence.Northwind.EmployeeRow.getLookup().items
        ...
        }(SimpleSence.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(SimpleSence.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        }(SimpleSence.Northwind.OrderDialog));
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    SimpleSence.Northwind.CategoryService.Retrieve({
        ...
        }(SimpleSence.Northwind.CategoryDialog));
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        }(SimpleSence.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(SimpleSence.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new SimpleSence.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                SimpleSence.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(SimpleSence.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    SimpleSence.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(SimpleSence.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(SimpleSence.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    SimpleSence.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return SimpleSence.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return SimpleSence.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return SimpleSence.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return SimpleSence.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return SimpleSence.LanguageList.getValue();
            };
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        }(SimpleSence.Northwind.SupplierDialog));
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = (function (_super) {
            ...
            return ReadOnlyGrid;
        }(SimpleSence.Northwind.SupplierGrid));
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return SimpleSence.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return SimpleSence.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return SimpleSence.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return SimpleSence.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return SimpleSence.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                SimpleSence.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    SimpleSence.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(SimpleSence.Northwind.CustomerDialog));
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        }(SimpleSence.Northwind.CustomerGrid));
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = SimpleSence.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return SimpleSence.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(SimpleSence.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return SimpleSence.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new SimpleSence.Northwind.OrderDetailForm(_this.idPrefix);
                ...
                _this.form.ProductID.cascadeField = SimpleSence.Northwind.ProductRow.Fields.CategoryID;
                return _this;
        ...
        }(SimpleSence.Northwind.OrderDetailDialog));
...
(function (SimpleSence) {
    ...
    (function (Northwind) {
        ...
        }(SimpleSence.Common.GridEditorBase));
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        }(SimpleSence.Northwind.OrderDetailsEditor));
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return SimpleSence.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return SimpleSence.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return SimpleSence.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return SimpleSence.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return SimpleSence.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (SimpleSence) {
    ...
    SimpleSence.StaticTextBlock = StaticTextBlock;
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
    var BasicSamples;
    ...
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SimpleSence.BasicProgressDialog();
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        ...
        }(SimpleSence.Common.BulkServiceAction));
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return SimpleSence.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return SimpleSence.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return SimpleSence.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return SimpleSence.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = SimpleSence.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = SimpleSence.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(SimpleSence.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new SimpleSence.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new SimpleSence.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new SimpleSence.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, SimpleSence.Northwind.OrderRow.Fields.ShipCountry);
...
(function (SimpleSence) {
    ...
    SimpleSence.SelectableEntityGrid = SelectableEntityGrid;
})(SimpleSence || (SimpleSence = {}));
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return SimpleSence.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return SimpleSence.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return SimpleSence.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return SimpleSence.Northwind.SupplierService.baseUrl; };
            return RowSelectionGrid;
        }(SimpleSence.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = SimpleSence.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            SimpleSence.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return SimpleSence.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return SimpleSence.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return SimpleSence.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return SimpleSence.Northwind.ProductService.baseUrl; };
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return SimpleSence.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return SimpleSence.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return SimpleSence.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return SimpleSence.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return SimpleSence.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return SimpleSence.Northwind.CustomerGrossSalesRow.localTextPrefix; };
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: SimpleSence.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (SimpleSence) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return SimpleSence.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return SimpleSence.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return SimpleSence.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (SimpleSence) {
    ...
    SimpleSence.BasicProgressDialog = BasicProgressDialog;
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
    var DialogUtils;
    ...
    })(DialogUtils = SimpleSence.DialogUtils || (SimpleSence.DialogUtils = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
    var Common;
...
(function (SimpleSence) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SimpleSence.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SimpleSence.LanguageList || (SimpleSence.LanguageList = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
    var Common;
...
(function (SimpleSence) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = SimpleSence.LanguageList.getValue;
    })(ScriptInitialization = SimpleSence.ScriptInitialization || (SimpleSence.ScriptInitialization = {}));
})(SimpleSence || (SimpleSence = {}));
var SimpleSence;
(function (SimpleSence) {
    var Common;
        ...
        var MeetingAttendeeEditor = (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: SimpleSence.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = SimpleSence.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: SimpleSence.Authorization.userDefinition.DisplayName,
...
//# sourceMappingURL=SimpleSence.Web.js.map